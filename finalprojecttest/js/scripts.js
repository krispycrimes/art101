$(document).ready(function() {
    ...
    function fillEmptyFields() {
        const words = {
            ...
            department: ["HR", "Finance", "Development", "Child Protection Services", "Fire Department", "Legal Department", "the Local Charity", "The Orphanage"],
            ...
            negativeAdjective3: ["unprofessional", "rude", "disrespectful", "kinda sexy", "hot", "just plain weird", "freaky", "crazy", "sneaky"],
